...
class TestEdgeCases:
    def test_single_stop(self):
        ...
        routes, etas, _, _ = solve_vrptw(t, tw, courier_start_time=START, num_couriers=1)
        stops = _all_stops(routes)
        assert stops == [1]
